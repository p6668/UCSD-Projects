...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="runMetadataStore" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" surfstore.MetadataStore %CMD_LINE_ARGS%
